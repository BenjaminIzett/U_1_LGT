...
if isfile("measurements/$filename")
    ...
    Measurement.optimised_measure_range(filename, U_1_LGT.zero_lattice_3d(16, 16, 16), 250, 10, 50, HMC.hmc_run, update_args_list, (MeasurementFunctions.mean_plaquette_3d,), measurement_args_list, measurement_info_list, 3, 4, 250, 250)
end
